...
function setup() {
  ...
  offButton.position(100, 100);
  offButton.mouseClicked(lightOff);


  var onButton = createButton("light up"); //light up all lights
  onButton.position(100, 150);
  onButton.mouseClicked(lightUp);



  var seq1Button = createButton("openning"); //light up all lights
  seq1Button.position(100, 200);
  seq1Button.mouseClicked(myCheckedSeq1);


  var seq2Button = createButton("blue/purple flash"); //light up all lights
  seq2Button.position(100, 250);
  seq2Button.mouseClicked(myCheckedSeq2);



  var seq3Button = createButton("highlight face"); //light up all lights
  seq3Button.position(100, 300);
  seq3Button.mouseClicked(myCheckedSeq3);


  var seq4Button = createButton("cool scene"); //light up all lights
  seq4Button.position(100, 350);
  seq4Button.mouseClicked(myCheckedSeq4);



  var seq5Button = createButton("warm scene"); //light up all lights
  seq5Button.position(100, 400);
  seq5Button.mouseClicked(myCheckedSeq5);



  var seq6Button = createButton("end scene"); //light up all lights
  seq6Button.position(100, 450);
...
function sequence5() { // highlight face
  ...
  setLight(lightNumber[1], lightState3);
...
function sequence6() {
  ...
  var lightState4 = {             // Strip blue 41579
      bri: 254,
      sat: 254,
      hue: 41579,
      on: true
